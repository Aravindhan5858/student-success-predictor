    ...
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-100 to-indigo-50 p-4">
      <div className="w-full max-w-md space-y-5">
        ...
        <AdvancedFeatureCard
          ...
          description="Quick navigation recovery options after invalid route access."
          points={[
            'Return to dashboard for primary navigation context.',
            'Use sidebar routes to reopen recent prediction workflows.',
            'Validate URL path to avoid broken deep links.',
          ]}
          tone="medium"
        />
      </div>
