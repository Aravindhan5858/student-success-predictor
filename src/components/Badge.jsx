function Badge({ children, tone = 'low', className = '' }) {
  const tones = {
    ...
    orange: 'bg-orange-500/15 text-orange-100 ring-orange-400/45 shadow-[0_0_14px_rgba(249,115,22,0.45)]',
    purple: 'bg-violet-500/15 text-violet-100 ring-violet-400/45 shadow-[0_0_14px_rgba(139,92,246,0.45)]',
  }
