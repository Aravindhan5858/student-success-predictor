...
class Profile(Base):
    ...
    resume_analysis_status: Mapped[str] = mapped_column(String(20), nullable=False, server_default="not_started")
    resume_analysis_summary: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    resume_analyzed_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
